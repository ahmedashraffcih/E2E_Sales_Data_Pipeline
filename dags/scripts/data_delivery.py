...
def load_sales_dim(host,db_name,user,password):
    try:
        ...
        sales_df = sales_df[['order_id','customer_id','product_id','quantity','price','order_date','store_id','weather','description','temp','pressure','humidity']]
...
def load_product_data(host,db_name,user,password):
    try:
        ...
        load_data_to_postgres('dim_product_master',product_df,host,db_name,user,password)
